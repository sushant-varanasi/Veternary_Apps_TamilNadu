...
import '../adminAttendCase.dart';
import '../caseClass.dart';
import '../casePage.dart';

class CaseTile_1 extends StatefulWidget {
  final CaseData casestile;
  CaseTile_1({this.casestile});
  @override
  _CaseTile_1State createState() => _CaseTile_1State();
}

class _CaseTile_1State extends State<CaseTile_1> {
  @override
