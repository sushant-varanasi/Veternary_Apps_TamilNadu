...
class CaseTile_5 extends StatefulWidget {
  final CaseData casestile;
  CaseTile_5({this.casestile});
  @override
  _CaseTile_5State createState() => _CaseTile_5State();
}

class _CaseTile_5State extends State<CaseTile_5> {
  @override
