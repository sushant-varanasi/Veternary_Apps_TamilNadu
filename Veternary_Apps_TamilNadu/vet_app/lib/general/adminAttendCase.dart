...
import 'package:vet_app/general/admincasebase.dart';
                ...
                child: ListView(
                  children: <Widget>[
                    ...
                    TextFormField(
                        ...
                        validator: (val) =>
                            val.isEmpty ? 'Enter Comment to User' : null,
                    ...
                    DropdownButtonFormField(
                      ...
                      validator: (val) =>
                          val.isEmpty ? 'Choose Severity' : null,
                      hint: Text('Severity'),
                      value: severityDoc,
