...
import 'package:vet_app/english/addlocationtocase.dart';
...
import 'package:vet_app/english/recordcase.dart';
                ...
                child: Form(
                  ...
                  child: ListView(
                    children: <Widget>[
                      ...
                      SizedBox(height: 20),
                      Text('Breed: ' + widget.petcase.breed,
                          style: TextStyle(fontSize: 18.0)),
                      SizedBox(height: 20),
                      Text('AnimalId: ' + widget.petcase.puid,
                          style: TextStyle(fontSize: 18.0)),
                      SizedBox(height: 20),
                      Card(
                        child: Column(
                      ...
                      RadioListTile(
                        ...
                        title: Text('Home visit required'),
                        value: true,
                        onChanged: (val) {
                          setState(() {
                            homevisit = val;
                      ...
                      RadioListTile(
                        groupValue: homevisit,
                        title: Text('Home visit not required'),
                        value: false,
                        onChanged: (val) {
                          setState(() {
                            homevisit = val;
