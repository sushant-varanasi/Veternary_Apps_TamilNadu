                  ...
                  children: <Widget>[
                    ...
                    TextFormField(
                        decoration: textInputDecoration.copyWith(
                            hintText: 'உங்கள் ஆதார் எண்ணை உள்ளிடவும்'),
                    ...
                    Padding(
                        ...
                        child: TextFormField(
                          ...
                          validator: (val) => val.isEmpty
                              ? 'ஒரு தொலைபேசி என்னை உட்செலுத்தவும்'
                              : null,
                          onChanged: (val) {
                            setState(() {
                              this.phoneNo = '+91' + val;
                    ...
                    Padding(
                        ...
                        child: RaisedButton(
                            ...
                            onPressed: () {
                              codeSent
                                  ? AuthService().registerWithOTP(smsCode,
                                      verificationId, name, aadhaar, phoneNo)
                                  : verifyPhone(phoneNo);
                            })),
                    SizedBox(height: 30),
/*
